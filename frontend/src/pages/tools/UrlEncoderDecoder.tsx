...
import { Globe, Copy, Check, ArrowDown, ArrowUp } from 'lucide-react'
            ...
            <div className="w-full max-w-4xl flex flex-col items-center">
                ...
                >
                    ...
                    <p className="text-lg text-secondary max-w-xl mx-auto">
                        Safely encode or decode URLs and query strings.
                    </p>
                </motion.div>
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="p-6 rounded-2xl border border-border/40 bg-surface/40 backdrop-blur-sm h-full flex flex-col transition-all duration-300 hover:border-accent/30">
                            ...
                            <div className="flex flex-wrap items-center gap-3 mt-4">
                                ...
                                >
                                    <ArrowDown className="w-4 h-4 mr-2" /> Encode URL
                                </Button>
                                <Button
                                ...
                                >
                                    <ArrowUp className="w-4 h-4 mr-2 text-secondary group-hover:text-accent transition-colors" /> Decode URL
                                </Button>
                            </div>
                        </div>
                    </div>
